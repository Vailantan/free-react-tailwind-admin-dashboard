    ...
    <>
      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="relative z-20 h-35 md:h-65">
          <img
            src="https://as2.ftcdn.net/v2/jpg/02/91/15/05/1000_F_291150525_KrGedVdpp1mILROPK4BwZ8dF5x6w1H1B.jpg"
            alt="profile cover"
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white p-1 sm:h-44 sm:max-w-44 sm:p-3">
            <div className="relative drop-shadow-2">
              <img src="login_recycle.png" alt="profile" />
              <label
                htmlFor="profile"
          ...
          <div className="mt-4">
            ...
            <p className="font-medium">Recycling Firm</p>
            ...
            <div className="mx-auto max-w-180">
              ...
              <br></br>
            <textarea id="message" rows="4" style={{backgroundColor:"#24303F"}} class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write about your company..."></textarea>
